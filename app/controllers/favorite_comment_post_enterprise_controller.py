...
from app.utils.enums.sum_red import ColumnUserMetricEnum, SumRedEnum, ColumnsCommentPostEnterpriseMetricEnum
...
async def toggle(
    ...
    try:
        ...
        if favor:
            ...
            await user_metric_service.update_metric_v2(user_id, ColumnUserMetricEnum.favorite_comment_count, SumRedEnum.RED)
            await comment_enterprise_metric_service.update_metric(comment_enterprise_id, ColumnsCommentPostEnterpriseMetricEnum.favorites_count, SumRedEnum.RED)
        ...
        await user_metric_service.update_metric_v2(user_id, ColumnUserMetricEnum.favorite_comment_count, SumRedEnum.SUM)

        await comment_enterprise_metric_service.update_metric(
            comment_enterprise_id,
            ColumnsCommentPostEnterpriseMetricEnum.favorites_count,
            SumRedEnum.SUM
        )
