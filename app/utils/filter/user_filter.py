...
class UserFilter(Filter):
    ...
    email__ilike: Optional[str] = Field(None, description="Search by email (case-insensitive).")
    bio__ilike: Optional[str] = Field(None, description="Search by bio (case-insensitive).")
